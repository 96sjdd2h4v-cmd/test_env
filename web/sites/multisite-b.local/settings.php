...
$settings['hash_salt'] = 'multisiteb-hash-salt-123456789';
...
if (extension_loaded('redis')) {
  ...
  #prefix voor multi site b
  $settings['cache_prefix']['default'] = 'ms_b_';
}
...
// Overschrijf de Solr connector instellingen specifiek voor Cluster A
// 1. Database van deze site staat in cluster A.
$databases['default']['default']['host'] = 'postgres-a';
...
$config['search_api.server.central_solr']['backend_config']['connector_config']['core'] = 'drupal_cluster_b';
