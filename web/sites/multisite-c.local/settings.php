...
if (extension_loaded('redis')) {
  ...
  # Unieke Redis-prefix voor multisite C.
  $settings['cache_prefix']['default'] = 'ms_c_';
}
...
$config['search_api.server.central_solr']['backend_config']['connector_config']['core'] = 'drupal_cluster_c';
