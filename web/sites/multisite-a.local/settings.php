...
if (extension_loaded('redis')) {
  ...
  #prefix voor multi site a
  $settings['cache_prefix']['default'] = 'ms_a_';
}
...
$config['search_api.server.central_solr']['backend_config']['connector_config']['core'] = 'drupal_cluster_a';
